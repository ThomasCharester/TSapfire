...
namespace Code.Infrastructure.Installers
{
    public class BootstrapInstaller : MonoInstaller, ICoroutineRunner, IInitializable
    {
        ...
        {
            Container.Bind<IInputService>().To<InputService>().AsSingle().WithArguments(InputActionAsset); // Чё по InputAsset?
        }
        public void Initialize()
        {
            Container.Resolve<ISceneLoader>().LoadScene("IslandSkeleScene");   
        }

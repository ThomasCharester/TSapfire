...
public partial class GameEntity {
    ...
    public Code.Gameplay.Common.RotationSpeed rotationSpeed { get { return (Code.Gameplay.Common.RotationSpeed)GetComponent(GameComponentsLookup.RotationSpeed); } }
    ...
    public GameEntity AddRotationSpeed(float newValue) {
        ...
        var component = (Code.Gameplay.Common.RotationSpeed)CreateComponent(index, typeof(Code.Gameplay.Common.RotationSpeed));
